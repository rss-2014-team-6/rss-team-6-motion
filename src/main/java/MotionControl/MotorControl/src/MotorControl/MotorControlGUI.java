...
public class MotorControlGUI extends JFrame implements WindowListener {
    ...
    protected Component setupRobotPanel() {
        ...
        diffSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                ...
                wheelPanel[RobotBase.LEFT].setWheelVelocity(lwv
                        + (diffV - diffVWas) / 2.0);
            }
        });
    ...
    protected JPanel setupBottomPanel() {
        ...
        low.setBorder(new CompoundBorder(BorderFactory.createLineBorder(
                Color.black, 1), BorderFactory
    ...
    class WheelPanel extends JPanel {
        ...
        protected JRadioButton manualRadioButton = new JRadioButton("Manual",
                false);
        ...
        protected JSlider desiredSlider = new JSlider(-255 * DES_RES,
                255 * DES_RES, 0);
        protected JTextField desiredValue = new JTextField("0", 3);
        protected JPanel desiredSliderPanel = new JPanel(new FlowLayout(
                FlowLayout.LEADING));
        protected JLabel desiredLabel = new JLabel("");
        protected JLabel desiredUnitsLabel = new JLabel("");

        protected JSlider gainSlider = new JSlider(-30 * GAIN_RES,
                30 * GAIN_RES, 0);
        protected JTextField gainValue = new JTextField("1.00", 5);
        protected JPanel gainPanel = new JPanel(new FlowLayout(
                FlowLayout.LEADING));
        ...
        public WheelPanel(String side, int wheel) {
            ...
            inputFunctionTimer = new Timer(50,
                    new InputFunctionActionListener());
        ...
        protected void addReadOnlyValuePanel(String title, JLabel value,
                String units) {
        ...
        protected void setWheelVelocity(double v) {
            ...
            if (rvc instanceof RobotVelocityControllerBalanced) {
                ...
                double otherV = v + diffV
                        * ((wheel == RobotBase.LEFT) ? -1.0 : 1.0);
        ...
        class DesiredSliderListener implements ChangeListener {
            public void stateChanged(ChangeEvent e) {
                setWheelVelocity(((double) (desiredSlider.getValue()))
                        / DES_RES);
            }
        }
    ...
    public void windowClosing(WindowEvent arg0) {
        /*
         * robot.enableMotors(false); motorsEnabled = false;
         */
        robot.estop();
